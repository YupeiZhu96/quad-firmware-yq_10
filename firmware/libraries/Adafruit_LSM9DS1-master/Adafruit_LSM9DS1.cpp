...
bool Adafruit_LSM9DS1::begin()
{
  ...
  */
  ...
  write8(XGTYPE, LSM9DS1_REGISTER_CTRL_REG6_XL, 0x72); // 1 KHz out data rate, BW set by ODR, 408Hz anti-aliasing
  write8(XGTYPE, LSM9DS1_REGISTER_CTRL_REG7_XL, 0xA1);
